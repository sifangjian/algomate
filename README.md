...
算法学习是一个长期的、枯燥的过程，容易中途放弃、前学后忘。你是否也面临这样的困扰？

**AlgoMate 算法大陆** 是一款基于 AI Agent 的游戏化算法学习助手。它将算法学习转化为一场冒险旅程——你在「算法大陆」上收集卡牌、挑战 Boss、对抗遗忘，最终成为掌握算法技巧的冒险者。

### 🎯 核心价值

- **🎮 游戏化学习**: 卡牌收集、Boss 挑战、等级成长让学习不再枯燥
- **🧠 对抗遗忘**: 基于艾宾浩斯遗忘曲线理论的科学复习机制
- **🤖 AI 导师**: 通过对话问答学习算法技巧，AI 自动分析产出卡牌
...
- 卡牌有耐久度属性，长期不复习会降低，复习或击败 Boss 会提升
- 通过 NPC 对话学习或击败 Boss 掉落获得新卡牌

### 🤖 NPC 对话系统

- 与领域专家 NPC 进行气泡 UI 问答学习
- 对话结束后自动生成对应卡牌

...
class TestEndDialogueDBIntegration:
    ...
    def test_end_creates_card_in_db(self):
        ...
        card_data = {
            ...
            "algorithm_type": "动态规划",
            "durability": 80,
            "basic_content": json.dumps({
                "concept_definition": "0-1背包是经典DP问题",
                "features": "1. 定义状态\n2. 状态转移",
                "confusing_concepts": "",
            }),
            "practical_content": json.dumps({
                "examples": [{"title": "示例", "problem": "", "solutions": [{"name": "解法", "code": "def knapsack(): pass", "principle": "", "complexity": "O(n*W)"}]}],
                "applicable_scenarios": "资源分配",
                "precautions": "",
            }),
            "advanced_content": json.dumps({
                "common_mistakes": "初始化边界",
                "extensions": "与贪心区别",
                "advanced_solutions": "完全背包",
            }),
            "my_notes": "用户笔记",
            "visual_links": "[]",
            "npc_id": npc_id,
